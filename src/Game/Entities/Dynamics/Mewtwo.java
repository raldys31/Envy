...
public class Mewtwo extends BaseHostileEntity implements Fighter{
    ...
    public Mewtwo(Handler handler, int xPosition, int yPosition, String state, String name, String area, BufferedImage[] animFrames) {
        ...
        animDown = new Animation(animWalkingSpeed, Images.mewtwo_front);
		animLeft = new Animation(animWalkingSpeed, Images.mewtwo_left);
		animRight = new Animation(animWalkingSpeed, Images.mewtwo_right);
		animUp = new Animation(animWalkingSpeed, Images.mewtwo_back);
        
        this.foundState = state;
        mewtwo = new Rectangle();
    }
    ...
    public void render(Graphics g) {
        ...
        if(handler.getArea().equals(this.Area)) {
            if (!Player.checkInWorld) {
                mewtwo = new Rectangle((int) (handler.getXDisplacement() + getXOffset()),
                        (int) (handler.getYDisplacement() + getYOffset()), 45, 45);

            } else {
                mewtwo = new Rectangle((int) (handler.getXInWorldDisplacement() + getXOffset()),
            ...
            g.drawImage(getCurrentAnimationFrame(animDown,animUp,animLeft,animRight,Images.mewtwo_front,Images.mewtwo_back,Images.mewtwo_left,Images.mewtwo_right), mewtwo.x,mewtwo.y,mewtwo.width,mewtwo.height,null);

            if (mewtwo.intersects(handler.getEntityManager().getPlayer().getCollision())) {
